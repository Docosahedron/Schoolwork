...
public class MainApp extends Application {
    ...
    public void goToLoginStage() throws IOException {
        FXMLLoader loginLoader = new FXMLLoader(getClass().getResource("/front/Views/login.fxml"));
        ...
        scene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("/front/Views/Login.css")).toExternalForm());
    ...
    public void goToResiterStage() throws IOException {
        FXMLLoader registerLoader = new FXMLLoader(getClass().getResource("/front/Views/register.fxml"));
